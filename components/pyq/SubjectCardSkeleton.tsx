...
export default function SubjectCardSkeleton() {
    return (
        <Card noHover className="flex flex-col h-full bg-[var(--color-card)] border-[var(--color-border)]">
            ...
            <div className="mt-auto pt-6 border-t border-[var(--color-border)]/10 flex items-center justify-between">
