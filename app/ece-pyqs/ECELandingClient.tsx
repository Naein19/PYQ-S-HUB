...
export default function ECELandingClient() {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                console.error('Failed to load ECE subjects:', err);
            } finally {
                setLoading(false);
            }
        };
                ...
                <div className="container-main">
                    <div className="flex items-center justify-between mb-12">
                        <h2 className="text-2xl font-bold text-[#111827] uppercase tracking-tighter">
                            MODULE REPOSITORIES ({loading ? '...' : subjects.length})
                        </h2>
                ...
                <div className="container-main">
                    <div className="max-w-4xl mx-auto p-12 border border-[var(--color-border)]/10 bg-[var(--color-card)] relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-start gap-8">
                            ...
                            <div>
                                <h3 className="text-2xl font-black text-[var(--color-text)] uppercase tracking-tighter mb-4">Engineering Protocol // ECE</h3>
                                <p className="text-[var(--color-muted)] leading-relaxed mb-6">
                                    ECE modules require strong visualization of circuit dynamics. Reviewing past papers often reveals standard circuit topologies.
                                </p>
                                <Link href="/explore">
