                    ...
                    <div className="max-w-[800px] mx-auto">
                        <div className="space-y-16">
                            ...
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-[var(--color-text)] uppercase tracking-tighter mb-6">Institutional Respect.</h3>
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={idx} className="flex gap-6 p-6 border border-[var(--color-border)]/5 bg-[var(--color-card)] rounded-sm">
                                            <item.icon className="w-6 h-6 text-[#4338CA] shrink-0" />
                                            <div>
                                                <h4 className="font-black text-[var(--color-text)] uppercase tracking-tight mb-1">{item.title}</h4>
                            ...
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-[var(--color-text)] uppercase tracking-tighter mb-6">Sourced for Precision.</h3>
                                <p className="text-lg text-[var(--color-muted)] leading-relaxed mb-6">
                            ...
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-[var(--color-text)] uppercase tracking-tighter mb-6">The Ethical Vector.</h3>
                                <p className="text-lg text-[var(--color-muted)] leading-relaxed">
