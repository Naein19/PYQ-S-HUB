...
export default function SubjectWiseClient() {
                ...
                <div className="container-main relative z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl md:text-2xl text-[#A3A3A3] font-medium max-w-2xl mx-auto leading-relaxed">
                            ...
                            Structured data extraction for over {loading ? '...' : subjects.length} engineering subjects.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20">
                <div className="container-main">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {loading
                            ? [...Array(12)].map((_, i) => <SubjectCardSkeleton key={i} />)
